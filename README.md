...
- #### [Architectural Overview](savanna_pos/docs/architecture.md)

- #### [Setup & Configuration](savanna_pos/docs/setup_configuration.md)

- #### [Key Features](savanna_pos/docs/features.md)

- #### [Key DocTypes](savanna_pos/docs/doctypes.md)

- #### [Customisations](savanna_pos/docs/customisations.md)

- #### [Dashboard & Reports](savanna_pos/docs/dashboard_reports.md)
...
```sh
bench --site <your.site.name.here> install-app savanna_pos
```
...
```sh
bench --site <your.site.name.here> run-tests --app savanna_pos
```
