...
frappe.ui.form.on(doctype, {
  refresh: async function (frm) {
    ...
    const { message: data } = await frappe.call({
      method:
        "savanna_pos.savanna_pos.utils.get_etims_action_data",
      args: {
        doctype: frm.doctype,
...
function executeCustomerAction(frm, actionType, settingsName) {
  ...
  switch (actionType) {
    case "search_customer":
      method =
        "savanna_pos.savanna_pos.apis.apis.perform_customer_search";
      args = {
    ...
    case "update_customer":
      method =
        "savanna_pos.savanna_pos.apis.apis.send_branch_customer_details";
      args = {
        name: frm.doc.name,
        settings_name: settingsName,
      };
    ...
    case "get_customer_details":
      method =
        "savanna_pos.savanna_pos.apis.apis.get_customer_details";
      args = {
        settings_name: settingsName,
        request_data: {
          doc_name: frm.doc.name,
